...
const projects = [{name: "Softbody Tetris Simulation", link:"", yearStart:2024, yearEnd:2024, madeWith:null, tools:["C++"], Role:null, description:"A simulation and raytracer"}]


export default function Home() {
  return (
    <main className="flex gap-10 w-full max-w-2xl flex-col items-center justify-between  bg-transparent sm:items-start overflow-scroll">
      <div className="flex w-full flex-col items-stretch gap-4 text-lg text-center text-neutral-700 dark:text-zinc-400">
        <h1 className="text-center h-35 text-5xl  font-normal tracking-tight text-foreground dark:text-secondary-100 pt-15 ">
      ...
      <div className="w-full flex flex-col gap-4 text-base font-normal sm:flex-col">
